...
const int NumSpMMInternalRegs = 1; // Used by spmm buffer
const int NumSpMMRegs = NumSpMMStandardRegs + NumSpMMInternalRegs;
...
const int SpMMBufFlagReg = NumSpMMStandardRegs;
